...
def simple_classifier2():
    ...
    model.add(klayers.Conv2D(input_shape=(200, 200, 1), filters=32, kernel_size=[3, 3], activation='relu'))
    ...
    model.add(klayers.Conv2D(filters=85, kernel_size=[3, 3], activation='relu'))

    model.add(klayers.Conv2D(filters=90, kernel_size=[3, 3], activation='relu', padding='same'))

    model.add(klayers.Conv2D(filters=95, kernel_size=[3, 3], activation='relu', padding='same'))

    model.add(klayers.MaxPooling2D(pool_size=[2, 2]))

    model.add(klayers.Conv2D(filters=100, kernel_size=[3, 3], activation='relu', padding='same'))

    model.add(klayers.Conv2D(filters=120, kernel_size=[3, 3], activation='relu', padding='same'))

    model.add(klayers.Conv2D(filters=140, kernel_size=[3, 3], activation='relu', padding='same'))
    ...
    model.add(klayers.Conv2D(filters=190, kernel_size=[3, 3], activation='relu', padding='same'))
    ...
    model.add(klayers.Dense(units=20, activation='relu', use_bias=True))
