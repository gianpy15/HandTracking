...
def regressor(input_shape, weight_decay=None, dropout_rate=0):
    ...
    p3 = kl.MaxPool2D()(c9)
    f = kl.Flatten()(p3)
    d1 = kl.Dense(units=2048, activation='relu', kernel_regularizer=weight_decay)(f)
    d1_bis = kl.Dense(units=2048, activation='relu', kernel_regularizer=weight_decay)(d1)
    d2 = kl.Dense(units=1024, activation='relu', kernel_regularizer=weight_decay)(d1_bis)
