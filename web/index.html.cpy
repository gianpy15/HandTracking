<html>
        ...
        <div class="content">
            <div class="image-left">
                <span class="helper"></span>
                    <img src="http://www.freepngimg.com/download/hands/1-hands-png-hand-image-.png" id="left_img">
            </div>
            <div class="image-right">
                <span class="helper"></span>
                    <img src="http://clipartbarn.com/wp-content/uploads/2016/10/Hand-clip-art-free-clipart-images.jpg" id="right_img">
            </div>
        </div>
    </body>
    ...
    <script type="text/javascript">
        ...
        left_img.addEventListener('click', function (e) {
        ...
        right_img.addEventListener('click', function (e) {
